...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String ALL_BY_USER      = "Meal.getAllByUser";
    public static final String BY_USER_BETWEEN  = "Meal.getBetweenHalfOpen";
